...
<head>
    ...
    <title>{{ $siteSettings['store_name'] ?? 'Cycle' }} - Sharing Economy Platform</title>
...
<body class="antialiased">
        ...
        <nav class="navbar navbar-expand-md navbar-dark sticky-top shadow-sm py-3">
            <div class="container">
                <a class="navbar-brand text-uppercase" href="{{ url('/') }}">
                    <img src="{{ asset('images/MAIN LOGO 1.png') }}" alt="Logo" height="34" style="object-fit: contain; max-width: 120px;">
                </a>
    ...
    <a href="{{ route('messages.index') }}" class="btn-floating-messages" aria-label="Messages">
