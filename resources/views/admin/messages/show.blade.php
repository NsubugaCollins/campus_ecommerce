                ...
                <div class="p-4 border-top border-secondary bg-dark bg-opacity-25">
                    ...
                    <form action="{{ route('admin.messages.store', $user->id) }}" method="POST">
                        ...
                        <div class="input-group">
                            <input type="text" name="message" class="form-control bg-dark border-secondary text-white py-3 px-4 shadow-none" 
                                   placeholder="Type your response..." required maxlength="1000" style="border-radius: 0.8rem 0 0 0.8rem;">
